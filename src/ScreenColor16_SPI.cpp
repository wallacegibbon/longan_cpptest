...
void ScreenColor16_SPI::write_bus(uint8_t data) {
	spi_cs_clr();
...
void ScreenColor16_SPI::write_data8(uint8_t data) {
	spi_dc_set();
	write_bus(data);
}

void ScreenColor16_SPI::write_data(uint16_t data) {
	spi_dc_set();
	write_bus(data >> 8);
	write_bus(data);
}

void ScreenColor16_SPI::write_reg(uint8_t data) {
	spi_dc_clr();
	write_bus(data);
}
