#ifndef __SCREENCOLOR16_SPI_H
#define __SCREENCOLOR16_SPI_H

#include <stdint.h>
#include "ScreenColor16.h"

class ScreenColor16_SPI : public ScreenColor16 {
public:
	ScreenColor16_SPI(int dev, int rst_port1, int rst_pin1,
			int cs_port1, int cs_pin1, int dc_port1, int dc_pin1,
			int width, int height) :
		ScreenColor16(width, height),
		spi_dev(dev), rst_port(rst_port1), rst_pin(rst_pin1),
		cs_port(cs_port1), cs_pin(cs_pin1),
		dc_port(dc_port1), dc_pin(dc_pin1) {}
